      ...
      <div className="container grid md:grid-cols-2 gap-10 items-center">
        <div className="order-2 md:order-1">
          ...
          <p className="mt-3 text-muted-foreground max-w-2xl">
            I’m Karan Bista, an AI/ML Engineer, passionate about building intelligent systems that power products with predictive insights, generative AI experiences, and scalable data-driven pipelines. My work bridges innovation with practicality, turning advanced models into solutions that truly deliver value.
          </p>
        ...
        <Reveal className="order-1 md:order-2 relative flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground">AI/ML Engineer | Fusemachines AI Fellow</p>
            </div>
          </div>
        </Reveal>
      </div>
